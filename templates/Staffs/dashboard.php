<?php
$logo=\Cake\ORM\TableRegistry::getTableLocator()->get('baseContent')->get('2')->get('bc_path');
$companyname = \Cake\ORM\TableRegistry::getTableLocator()->get('baseContent')->get('2')->get('bc_string');
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
            <img src="/img/<?php echo $logo ?>" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Communications</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Business</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Productivity</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="./pages/profile.html">
                    ...
                    <span class="nav-link-text ms-1">Discuss (via Slack)</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white " href="./pages/profile.html">
                    ...
                    <span class="nav-link-text ms-1">Kanban Board</span>
                </a>
            </li>


            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Human Resources</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white " href="./pages/profile.html">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            <a href="https://github.com/DynastyKids/CakeERP">CakeERP</a> © <script>document.write(new Date().getFullYear())</script> made by DynastyKids.
                        </div>
                    </div>
                    <div class="col-lg-6">
